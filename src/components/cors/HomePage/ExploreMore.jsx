...
const ExploreMore = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="hidden  lg:h-[200px]"></div>

        {/* Cards Group */}
      <div className=" gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap max-w-maxContent lg:bottom-[0] lg:left-[50%] lg:translate-y-[50%]  lg:translate-x-[10%]  text-black lg:mb-0 mb-3 lg:px-0 px-3">
